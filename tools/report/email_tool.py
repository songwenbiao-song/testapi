...
def test_send_text(content):   #邮件使用
    # 第三方 SMTP 服务
    mail_host = "smtp.163.com"  # 设置服务器
    mail_user = "swb155144@163.com"  # 用户名
    mail_pass = "OPTOIGYSLWQFVZFQ"  # 口令

    sender = 'swb155144@163.com'
    receivers = ['songwenbiao@speakin.ai']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
